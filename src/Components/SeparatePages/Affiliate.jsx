          ...
          <div className='flex justify-center items-center h-full max-w-[550px]'>
            <div className='w-full px-4 py-4 flex flex-col justify-center items-center'>
              ...
              <p className="text-base font-normal text-white flex gap-1 my-2">
                Total rewards: <img src={dollarsign} alt="" className="w-5 h-5" /> <span> $0.00 USD</span>
              </p>
                  ...
                  <div className="flex justify-between items-center gap-3 ">
                    <div className="flex items-center gap-1"> 
                      ...
                      <div className="flex flex-col">
                        ...
                        <p className="text-[#FFDE01] text-base font-normal flex items-center gap-1 w-full pt-1 h-8"><img src={dollarsign} alt="" className="w-7 h-7" />  Earn 0.1 USD</p>
                      </div>
                    </div>
                  ...
                  <div className="flex justify-between items-center gap-3 ">
                    <div className="flex items-center gap-1">
                      ...
                      <div className="flex flex-col">
                        ...
                        <p className="text-[#FFDE01] text-base font-normal flex items-center gap-1 w-full pt-1 h-8"><img src={dollarsign} alt="" className="w-7 h-7" />  Earn 0.25 USD</p>
                      </div></div>
            ...
            <div className={`realtive ${msgbarOpen ? "w-full md:w-60" : ""}`}>  <div className={`fixed  inset-y-0 top-[70px] h-[500px] max-h-[600px] right-0 w-full z-50 bg-primarycl overflow-y-auto scroll-smooth transition-transform duration-300 transform ${msgbarOpen ? "-translate-x-0 md:translate-x-0" : "translate-x-full md:translate-x-0"}`}>
